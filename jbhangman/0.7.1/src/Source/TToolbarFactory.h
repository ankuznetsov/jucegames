...
public:
    ...
    ToolbarButton* pGameNewButton;
    ToolbarButton* pGameQuitButton;
    TWLComboBox* pWLComboBox;
    TThemeComboBox* pThemeComboBox;
    ToolbarButton* pHelpAboutButton;
    ToolbarButton* pHelpAboutJuceButton;
    ToolbarButton* pSettingsSaveButton;
